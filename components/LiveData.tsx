...
export function LiveData() {
    ...
    const tLiveData = useTranslations('Citizen.Landing.LiveData')

    return (
        <section className="py-16 px-4 bg-muted/30" id="live-data">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold mb-3">{tLiveData('title')}</h2>
                    <p className="text-muted-foreground text-lg">{tLiveData('description')}</p>
                </div>
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground mt-2">{tLiveData('weather.partlyCloudy')}</div>
                                </div>
                                <div className="text-right">
                                    <div className="text-base font-medium">{tLiveData('weather.colombo')}</div>
                                    <div className="text-xs text-muted-foreground mt-1">{tLiveData('weather.updatedNow')}</div>
                                </div>
                            </div>
                            <Button
                                variant="ghost"
